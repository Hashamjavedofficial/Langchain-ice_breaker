...
def implement_query_model(model, prompt):
    ...
    prompt_template = PromptTemplate(
        input_variables=[], template= prompt
    )
...
def implement_compare_models(prompt):
    ...
    llama3_modal = implement_llama_3_3_model()
    llama4_modal = implement_llama_4_model()

    llama3_res = implement_query_model(llama3_modal,prompt)
    llama4_res = implement_query_model(llama4_modal,prompt)

    return {
        "items": [
        {"responses": llama3_res, "model": "llama3"},
        {"responses": llama4_res, "model": "llama4"},
    ]
    }
